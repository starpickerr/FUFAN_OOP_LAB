public class ReversiBoard extends Board {
    ...
    public void printBoard(Player player1, Player player2, Player currentPlayer) {
        clearScreen();
        int score1 = calculateScore(player1); // 计算玩家1的分数
        int score2 = calculateScore(player2); // 计算玩家2的分数
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            // 打印玩家1的信息（第4行）
            if (i == 3) {
                System.out.print("   " + player1.getName() + " " + player1.getSymbol() + " " + score1);
            }
            // 打印玩家2的信息（第5行）
            if (i == 4) {
                System.out.print("   " + player2.getName() + " " + player2.getSymbol() + " " + score2);
            }
            if( i > 4) {
